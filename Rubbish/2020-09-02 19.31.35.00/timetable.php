                            ...
                            <div id="timetable">
                                ...
                                for ($i=1; $i <= $numberdays; $i++) { 
                                    ...
                                    if($comp_status == 1){
                                        ...
                                        $href = "<a href='dates_weapon_control.php?comp_id=$comp_id&date=$year-$monthid-$ione'>$toinneronclick</a>";
    
                                    }


                                    echo "<div id='$year-$monthid-$ione' onclick='$toonclick'><p>$i</p$href></div>";
