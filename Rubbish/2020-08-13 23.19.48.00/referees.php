...
if(isset($_POST["import_ref"])) {
    ...
    $comp_ref_from = $_COOKIE["selected"];
    
    $query_add_comp = "SELECT * FROM referees WHERE ass_comp_id regexp '(^|[[:space:]])$comp_id([[:space:]]|$)' EXCEPT SELECT * FROM referees WHERE ass_comp_id regexp '(^|[[:space:]])$comp_id([[:space:]]|$)'";
    ...
    <div id="flexbox_container">
        ...
        <div class="page_content_flex">
            <div class="page_content_panel">
                <div id="title_stripe">
                        <p class="page_title">Referees <?php echo $comp_ref_from ?></p>
                        ...
                        <div id="import_technician_panel" class="thin_overlay_panel overlay_panel hidden">
                            ...
                            <button type="submit" name="import_ref" class="submit_button" form="import_ref">
