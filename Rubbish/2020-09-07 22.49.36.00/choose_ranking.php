...
$assigned_to_ranking = "SELECT * FROM competitions WHERE comp_id = $comp_id AND comp_ranking_id != 0";
...
if(isset($_POST["submit"])){
    ...
    $get_id_do = mysqli_query($connection, $create_table);

    $newid = $get_id_do + 1;

    echo $newid;

    $update_id = "UPDATE competitions SET comp_ranking_id = $newid WHERE comp_id = $comp_id";
    $update_id_do = mysqli_query($connection, $create_table);
