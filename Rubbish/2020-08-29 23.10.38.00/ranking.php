...
<body>
    <div id="confirmation" class="" autocomplete="off" class="hidden">
        <form id="create_ranking_form" action="timetable.php?comp_id=<?php echo $comp_id ?>" method="POST">
            ...
            <p id="" class="confirmation_title">Create Ranking</p>
            <div id="create_ranking_form_wrapper">
                <label for="ranking_name" class="label_text">NAME</label></br>
                <input class="" type="text" id="" name="ranking_name">
                <label for="password" class="label_text">PASSWORD</label></br>
                <input class="" type="password" id="" name="ranking_password">
            </div>
            ...
            <div id="confirmation_button_section">
                ...
                <button onclick="" name="" type="submit" value="{Action}" class="action">Create</button>
            </div>
        </form>
    </div>
<!-- header -->
        ...
        <div class="page_content_flex">
            <div class="page_content_panel">
                ...
                <div id="page_content_panel_main">
                    ...
                    <div id="add_fencer_panel" class="big_overlay_panel overlay_panel" class="hidden">
                    ...
                    <div id="ranking_info_panel" class="thin_overlay_panel overlay_panel" class="hidden">
                        <button id="close_button" class="round_button" onclick="toggleRankingInfo()">
                            ...
                            <label class="label_text">CREATOR</label>
                            <p>lO</p>
                        </div>
                    </div>
