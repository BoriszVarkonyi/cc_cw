                ...
                <div id="title_stripe">
                    ...
                    <div id="add_technician_panel" class="big_overlay_panel overlay_panel hidden" >
                        ...
                        <form action="technicians.php?comp_id=<?php echo $comp_id; ?>" method="POST" id="new_technician" autocomplete="off">
                            ...
                            <label for="password"class="label_text">FULL NAME</label></br>
                            <input type="password" placeholder="Type the referees's full name" id="full_name_input" name="full_name" class="no_margin_input">
