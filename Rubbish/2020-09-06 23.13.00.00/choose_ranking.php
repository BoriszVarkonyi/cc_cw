...
if(isset($_POST["submit"])){
    ...
    //$create_table = "INSERT INTO `ranking` VALUES (,$name,$pass,$comp_id)";
    $create_table_do = mysqli_query($connection, "INSERT INTO `ranking`(`id`, `name`, `password`, `ass_comp_id`) VALUES (,$name,$pass,$comp_id)");
