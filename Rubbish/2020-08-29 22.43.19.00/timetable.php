                    ...
                    <div id="timetable_wrapper">
                        ...
                        <div id="timetable_container">
                            ...
                            <div id="timetable">
                                ...
                                if($comp_status == 1){
                                    $toinneronclick = "removeWcDay(this)";
                                }
                                else{
                                ...
                                for ($i=1; $i <= $numberdays; $i++) { 
                                    ...
                                    echo "<div id='$year-$monthid-$ione' onclick='$toonclick'><p>$i</p> <button onclick=''> <img src='..\assets\icons\alarm_off-black-18dp.svg'> </button> </div>";
