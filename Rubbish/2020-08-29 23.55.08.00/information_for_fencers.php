...
$equipment = array("Epee","Foil","Sabre","Electric Jacket","Plastron","Under-Plaston","Socks","Mask","Gloves","Bodywire","Maskwire","Chest protector","Metallic glove");
$hasequipment = array();
...
if(isset($_POST["submit"])){
    ...
    if(!empty($_POST['equipment'])) {
        echo "Missing values.".$_POST['equipment']." Missing values.";
     }
