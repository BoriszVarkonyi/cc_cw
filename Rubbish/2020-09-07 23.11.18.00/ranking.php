...
if(isset($_POST["create"])){
    ...
    $create_table = "INSERT INTO `ranking`(`id`, `name`, `password`, `ass_comp_id`) VALUES (,$name,$pass,$comp_id)";
...
<body>
    <div id="confirmation" class="hidden" autocomplete="off">
            ...
            <div class="page_content_panel">
                ...
                <div id="page_content_panel_main">
                    ...
                    <div id="ranking_info_panel" class="thin_overlay_panel overlay_panel hidden">
                        ...
                        $get_ranking_info_do = mysqli_query($connection, $assigned_to_ranking);
