...
function toggleWcPanel(x) {
    ...
    if (swb >= maxheight) {
        console.log("too long height");
        setWcPanel.style.top = null;
        setWcPanel.style.bottom = "20px";
    } else if (swr >= maxwidth) {
        console.log("too long width");
        setWcPanel.style.left = null;
        setWcPanel.style.right = "20px";
    } else if (swr <= maxheight) {
        console.log("good height");
        setWcPanel.style.bottom = null;
        setWcPanel.style.top = cdy;
    } else if (swr <= maxwidth) {
        console.log("good width");
        setWcPanel.style.right = null;
        setWcPanel.style.left = cdr;
