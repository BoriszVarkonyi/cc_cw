                            ...
                            <div>
                                <div>
                                        ...
                                        for ($i=$ora; $i < $oraig ; $i++) { 
                                            ...
                                            <div id='<?php echo $ora . "_" . $perc?>' class='ten_minutes_wrapper'>
                                                    <p><?php echo $ora ?>:00 - <?php echo $ora ?>:<?php echo $perc ?>9</p>
                                                        <p><?php echo $maxinperiod ?> / <?php echo strlen($row["ids"]); ?></p>
                                                </div>
                                            ...
                                            $perc++;
                                            ?>
                                            <div class="hidden fencers_wrapper" id="">
                                    <p>Ember</p>
                                    <p>Ember</p>
                                    <p>Ember</p>
                                    <p>Ember</p>
