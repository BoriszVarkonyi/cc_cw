...
$query_do = mysqli_query($connection, $query);
if($query_do){
echo $datetoremove . "DR";
print_r($array);
echo "::::::";
print_r($secondplode);
echo "::::::";
echo $datetoremove . "DATETOREMOVE";
echo "::::::";
echo $finaldelete . "FINALDELETE";
echo "::::::";
echo $upload_deleted . "THIS";
}
}
    ...
    <div id="flexbox_container">
        ...
        <div class="page_content_flex">
            <div class="page_content_panel">
                <div id="title_stripe">
                    <p class="page_title">Timetable <?php print_r($string); echo "<br>" . $finaldelete ; ?></p>
                ...
                <form action="timetable.php?comp_id=<?php echo $comp_id ?>" method="POST">
                <input type="text" id="remove_date" name="remove_date">
                <input type="submit" name="sure_delete" id="sure_delete" value="sure_delete">
                </form>
