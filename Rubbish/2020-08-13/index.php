...
<head>
    ...
    <link rel="stylesheet" media="only screen and (min-width: 768px)" href="/css/mainstyle.css">
    <link rel="stylesheet" media="only screen and (max-width: 768px)" href="/css/phonestyle.css">
</head>
