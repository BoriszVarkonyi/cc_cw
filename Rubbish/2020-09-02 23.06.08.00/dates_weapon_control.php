...
$query_get_max = "SELECT * FROM `wc_2020-09-03_52` WHERE hour = `999`";
$query_get_max_do = mysqli_query($connection, $query);
            ...
            <div class="page_content_panel">
                ...
                <div id="page_content_panel_main">
                    <div id="dates_weapon_control_wrapper">
                        ...
                        $query = "SELECT * FROM `wc_2020-09-03_52`";
                        ...
                        while($row = mysqli_fetch_assoc($query_do)){
                            ...
                            <div>
                                <div>
                                        ...
                                        $query_in = "SELECT * FROM `wc_2020-09-03_52` WHERE hour = $ora";
