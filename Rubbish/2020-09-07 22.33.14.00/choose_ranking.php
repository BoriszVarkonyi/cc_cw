...
$assigned_to_ranking = "SELECT * FROM competitions WHERE comp_id = $comp_id AND comp_ranking_id NOT NULL";
$assigned_to_ranking_do = mysqli_query($connection, $assigned_to_ranking);

/*while($row = mysqli_fetch_assoc($assigned_to_ranking_do)){
