                ...
                <div id="page_content_panel_main">
                    <div id="dates_weapon_control_wrapper">
                        <div class="period" id="period_1" onclick="togglePeriodPanel(this)">
                            ...
                            <div>
                                <div>
                                    <p>{ST} : 00 - {ST} : 10</p> <p>{SF} / {AF}</p>
                                    <p>{ST} : 10 - {ST} : 20</p> <p>{SF} / {AF}</p>
                                    <p>{ST} : 20 - {ST} : 30</p> <p>{SF} / {AF}</p>
                                    <p>{ST} : 30 - {ST} : 40</p> <p>{SF} / {AF}</p>
                                    <p>{ST} : 40 - {ST} : 50</p> <p>{SF} / {AF}</p>
                                    <p>{ST} : 50 - {ST} : 59</p> <p>{SF} / {AF}</p>
                                </div>
                                <div>
                                    <button type="button">
