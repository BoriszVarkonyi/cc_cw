...
for ($i=0; $i < count($allwc); $i++) { 
    ...
    $query = "CREATE TABLE `ccdatabase`.`WC_$dayscontrolon[0]_$comp_id` ( `hour` INT(11) NOT NULL , /*in_hour INT(11) NOT NULL ,*/ `period` INT(11) NOT NULL , `ids` VARCHAR($dayscontrolon[1]) NOT NULL ) ENGINE = InnoDB;";
    $query_do = mysqli_query($connection, $query);
