                ...
                <div id="page_content_panel_main">
                    ...
                    <div id="set_wc_panel" class="overlay_panel big_overlay_panel">
                        <div class="form_wrapper">
                            ...
                            <form action="" method="POST" id="new_wc_day" autocomplete="off" class="hidden">
                            ...
                            <div id="timetable">
                                ...
                                for ($i=1; $i <= $numberdays; $i++) { 
                                    ...
                                    if($comp_status == 1){
                                        ...
                                        $href = "dates_weapon_control.php?comp_id=$comp_id&date=$year-$monthid-$ione";
    
                                    }


                                    echo "<div id='$year-$monthid-$ione' onclick='$toonclick'><a href='$href'><p>$i</p>$toinneronclick</a></div>";
