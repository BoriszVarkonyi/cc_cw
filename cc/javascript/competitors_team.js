var removeButton = document.getElementById("removeFencerBt");
...
document.addEventListener("keyup", function (e) {
    ...
    if (!somethingisOpened && !somethingIsFocused) {
        ...
        if (e.shiftKey && e.which == 80) {
            var printCompButton = document.getElementById("printCompBt")
            printCompButton.click();
        }
        if (e.shiftKey && e.which == 73) {
            var importCompButton = document.getElementById("importCompBt")
            importCompButton.click();
        }
        if (e.shiftKey && e.which == 88) {
            var importCompXMLButton = document.getElementById("importCompXMLBt")
            importCompXMLButton.click();
        }
    }
})