...
<?php
    ...
    $qry_select_wc = "SELECT issues_array FROM call_room_wc WHERE assoc_comp_id = '$comp_id'";
    ...
    while ($row = mysqli_fetch_assoc($do_select_wc)) {
        ...
        if ($row['issues_array'] !== null) {
            ...
            $real_issues_array = explode(',', $real_issues_string);
            ...
            for ($issues_id = 0; $issues_id < count($cr_array_issues); $issues_id++) {
    ...
    foreach ($sorted_issues_array as $issue_id => $issue_value) {
        if (isset($assoc_sorted_issues_array[$cr_array_issues[$issue_id]])) {
            $assoc_sorted_issues_array[$cr_array_issues[$issue_id]] += $issue_value;
        } else {
            $assoc_sorted_issues_array[$cr_array_issues[$issue_id]] = $issue_value;
        }
    }
    ...
    foreach ($sorted_teams_array as $nation => $fencer_ids_array) {
        ...
        foreach ($fencer_ids_array as $fencer_id) {
            ...
            $qry_select_fencer = "SELECT issues_array FROM call_room_wc WHERE assoc_comp_id = '$comp_id' AND fencer_id = '$fencer_id'";
                    ...
                    <div class="db_panel_main small">
                        <div class="stats_wrapper">
                            <a class="stat" href="callroom_immediate.php?comp_id=<?php echo $comp_id ?>">
                                ...
                                <p class="stat_number"><?php echo $submitted_wcs_count ?></p>
                            </a>
            ...
            <div class="print_only">
                <div>
                    ...
                    <div class="print_stat">
                        ...
                        <p><?php echo $submitted_wcs_count ?></p>
                    </div>
                    <div class="print_stat">
                        <img src="../assets/icons/report_problem_black.svg">
