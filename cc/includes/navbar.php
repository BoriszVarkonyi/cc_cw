...
<nav>
    ...
    <div id="nav_bar_content">
        ...
        <p id="overview_text" class="nav_bar_title">TOURNAMENT</p>
        <a href="competitions.php?comp_id=<?php echo $comp_id ?>" class="nav_bar_item">
        ...
        <p id="referee_text" class="nav_bar_title">REFEREE</p>
