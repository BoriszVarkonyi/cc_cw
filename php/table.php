                        ...
                        foreach ($out_table as $key => $tablerounds) { ?>
                            ...
                            <div id="e_<?php echo $r_counter ?>" class="elimination">
                                ...
                                ?>
                                    ...
                                    <div class="table_round_wrapper finished <?php echo $writecolor ?>" onclick="window.location.href='match_results.php?comp_id=<?php echo $comp_id ?>&table_round=<?php echo $key ?>&match_id=<?php echo $keyofmatch ?>'" tabindex="0">
